...
knitr::opts_chunk$set(warning = FALSE, eval = FALSE, echo = TRUE, tidy.opts=list(width.cutoff=90), tidy=TRUE)
```
...
##### DISCLAIMER: This assignment was particular difficult for me to do therefore, I used a combination other people's code from RPubs along with code provided from Professor Fulton and I am trying to understand their method to complete the assignment.
...
### Calculate CoVariance (Corelation)
```{r}
Sigma_=cor(scaled)
```
